...
public class Zadanie01k1 {
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.println("Imperatywne - Ilosc imion które mają 5 i wiecej znaków wynosi: "+licznik);
        ...
        System.out.println("Funkcyjne - Ilosc imion które mają 5 i wiecej znaków wynosi: "+count);
